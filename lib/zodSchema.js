...
export const zSchmea = z.object({
  ...
  title: z.string().min(3, "title is required expected minimum 3 letters"),
  ...
  review: z
    .string()
    .min(3, "Review is required and expected minimum 3 letters"),
  ...
  ordernote: z.string().min(3, "Order note is required").optional(),
});
